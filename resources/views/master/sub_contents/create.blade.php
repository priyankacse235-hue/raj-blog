...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Create Sub Content Into <small><b>{{ $blog_data->title }}</b></small></h1>
                </div>
                <div class="col-sm-6">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Create Sub Content</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="heading" placeholder="Heading Of Content" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img class="img-fluid" src="" alt="" id="image_preview" > 
                                            </div>
                                        </div>
                                    </div>
                                </div>
